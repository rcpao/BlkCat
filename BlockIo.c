...
EFI_BLOCK_IO_PROTOCOL  gBlkCatBlockIo = {
  ...
  (EFI_BLOCK_RESET)BlkCatBlockIoReset, // Reset
  BlkCatBlockIoReadBlocks,             // ReadBlocks
  BlkCatBlockIoWriteBlocks,            // WriteBlocks
  BlkCatBlockIoFlushBlocks             // FlushBlocks
};
...
EFI_BLOCK_IO2_PROTOCOL  gBlkCatBlockIo2 = {
  ...
  BlkCatBlockIoReadBlocksEx,   // ReadBlocks
  BlkCatBlockIoWriteBlocksEx,  // WriteBlocks
  BlkCatBlockIoFlushBlocksEx   // FlushBlocks
};
